...
public class TblQpbatStdBankDetail{
    ...
    public String getBankTransAt() {
        return bankTransAt;
    }

    public void setBankTransAt(String bankTransAt) {
        this.bankTransAt = bankTransAt == null ? null : bankTransAt.trim();
    }
    ...
    public void setLineBuf(String lineBuf) {
        this.lineBuf = lineBuf == null ? null : lineBuf.trim();
    }
